...
var t = Object.create, n = Object.defineProperty, r = Object.getOwnPropertyDescriptor, i = Object.getOwnPropertyNames, a = Object.getPrototypeOf, o = Object.prototype.hasOwnProperty, s = (e, t) => () => (e && (t = e(e = 0)), t), c = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), l = (e, t, a, s) => {
	...
	function bi(e, t, n, r, a, o) {
		...
		if (r = e, typeof e == "function") _i(e) && (s = 1);
			...
			case T: return e = gi(31, n, t, a), e.elementType = T, e.lanes = o, e;
	...
	function If(e, t, n) {
		if (t.count++, t.instance === null) switch (t.type) {
			...
			case "script": return o = Pf(n.src), (a = e.querySelector(Ff(o))) ? (t.instance = a, A(a), a) : (r = n, (a = mf.get(o)) && (r = p({}, n), zf(r, a)), e = e.ownerDocument || e, a = e.createElement("script"), A(a), Pd(a, "link", r), e.head.appendChild(a), t.instance = a);
...
async function E(e, t) {
	let { data: n, error: r } = await e.from("occupancy_events").select("id,resource_id,occupancy_change,recorded_at").order("recorded_at", { ascending: !1 }).limit(typeof t == "number" && t > 0 ? t : 25);
	if (r) throw r;
	return n || [];
}
...
var de = s((() => {})), fe = /* @__PURE__ */ c(((e) => {
	...
	function a(e) {
		if (!e) return 99;
		let t = i(e.current_occupancy, e.capacity);
	...
	function d({ value: t }) {
		...
		return /* @__PURE__ */ (0, n.jsx)("div", {
			...
			children: s.map((e, t) => /* @__PURE__ */ (0, n.jsx)("span", {
				...
				children: /* @__PURE__ */ (0, n.jsx)(l, { digit: e ?? 0 })
			}, `slot-${t}`))
		});
	}
	function p() {
		let [t, l] = (0, e.useState)(!1), [u, f] = (0, e.useState)(!0), [p, m] = (0, e.useState)("User"), [h, g] = (0, e.useState)({
			text: "",
			error: !1
		}), [_, v] = (0, e.useState)(""), [y, b] = (0, e.useState)(/* @__PURE__ */ new Map()), [x, ee] = (0, e.useState)(""), [S, te] = (0, e.useState)([]), [re, w] = (0, e.useState)([]), [ie, ae] = (0, e.useState)(""), [oe, se] = (0, e.useState)(!1), [de, fe] = (0, e.useState)(!1), pe = (0, e.useRef)(null), O = (0, e.useRef)(null), k = (0, e.useRef)(null), me = (0, e.useRef)(null), he = (0, e.useRef)(null), ge = (0, e.useRef)(null), _e = (0, e.useRef)(!1), ve = (0, e.useMemo)(() => Array.from(y.values()).filter((e) => e && (e.is_active === !0 || e.is_active == null)).sort((e, t) => {
			let n = a(e) - a(t);
		...
		}, [ye]), xe = (0, e.useMemo)(() => [...S, ...be], [S, be]), Se = (0, e.useMemo)(() => de ? re : re.slice(0, r), [de, re]), Ce = (0, e.useCallback)(async () => {
			if (!_e.current) {
				_e.current = !0;
				try {
					...
					console.error("loadOccupancy error", e), ee("Failed to load live occupancy. Showing sample data below."), g({
			...
			try {
				te((await ue(T, 8) || []).map((e) => ({
					id: e.id,
					type: "announcement",
					title: String(e.title || "Notice"),
					message: String(e.message || ""),
					when: s(e.start_at, e.end_at)
				})));
			} catch (e) {
				console.warn("loadAnnouncementAlerts error", e), te([]);
			}
		}, []), Te = (0, e.useCallback)(async () => {
			try {
				let e = await E(T, 25);
				e?.length && (ge.current = e[0].id);
				let t = Array.from(new Set((e || []).map((e) => e.resource_id).filter(Boolean))), n = /* @__PURE__ */ new Map();
				if (t.length > 0) try {
					(await D(T, t) || []).forEach((e) => {
						n.set(e.id, e);
					});
				} catch {}
				w((e || []).map((e) => ({
					...
					resource: e.resource_id ? n.get(e.resource_id) : null
				}))), ae("");
			} catch (e) {
				console.warn("loadRecentActivity error", e), w([]), ae("Recent activity is unavailable.");
			}
			...
			try {
				await Promise.all([
					...
					text: "",
					error: !1
				}), v(`Updated: ${(/* @__PURE__ */ new Date()).toLocaleString()}`);
			} catch (e) {
				console.error("loadAll error", e), g({
		...
		return (0, e.useEffect)(() => {
			...
			return (async () => {
				if (!(!await ne() || e)) {
					...
					e || (l(!0), Ee(), je(), De(1e3), Me(), ke(15e3), he.current = window.setInterval(() => {
						we();
					}, 3e4));
				}
			})(), () => {
			...
			children: [
				...
				/* @__PURE__ */ (0, n.jsx)("div", {
					id: "statusBar",
					className: `status-bar ${h.error ? "error" : ""}`,
					"aria-live": "polite",
					style: { display: h.text ? "" : "none" },
					children: h.text
				}),
						...
						children: [
								...
								children: ve.map((e) => {
									...
									return /* @__PURE__ */ (0, n.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, n.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, n.jsx)(d, { value: Math.max(0, t) }), /* @__PURE__ */ (0, n.jsxs)("div", {
							...
							/* @__PURE__ */ (0, n.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, n.jsx)("p", {
									...
									children: x || "No active resources. Showing sample data below."
								}), /* @__PURE__ */ (0, n.jsx)("div", {
									className: "occupancy-cards",
									"aria-hidden": "true",
									children: c().map((e) => /* @__PURE__ */ (0, n.jsxs)("div", {
										className: "occupancy-card",
										children: [/* @__PURE__ */ (0, n.jsxs)("div", {
											className: "occupancy-top",
											children: [/* @__PURE__ */ (0, n.jsxs)("div", { children: [/* @__PURE__ */ (0, n.jsx)("div", {
											...
											className: "occupancy-value-row",
											children: [/* @__PURE__ */ (0, n.jsx)(d, { value: e.current }), /* @__PURE__ */ (0, n.jsxs)("div", {
												className: "capacity-suffix",
												children: ["/ ", e.cap]
											})]
										})]
				...
				/* @__PURE__ */ (0, n.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, n.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, n.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, n.jsx)("button", {
									type: "button",
									className: "btn",
									style: { display: h.error ? "inline-block" : "none" },
									onClick: Ee,
									children: "Retry"
								}), /* @__PURE__ */ (0, n.jsx)("div", {
									className: "small-muted",
						...
						children: [/* @__PURE__ */ (0, n.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, n.jsx)("h3", { children: "Recent Activity" }), /* @__PURE__ */ (0, n.jsx)("button", {
								type: "button",
								className: "activity-toggle",
								onClick: () => se((e) => !e),
								children: oe ? "Hide activity" : "Show activity"
							})]
						}), oe ? /* @__PURE__ */ (0, n.jsxs)(n.Fragment, { children: [
							/* @__PURE__ */ (0, n.jsx)("ul", {
								className: "activity",
								children: Se.map((e) => {
									let t = Number(e.occupancy_change) === 1 ? "Entered" : "Exited", r = e.resource?.name || e.resource_id || "Space", i = e.resource?.location || "";
									return /* @__PURE__ */ (0, n.jsxs)("li", { children: [/* @__PURE__ */ (0, n.jsxs)("div", { children: [
										/* @__PURE__ */ (0, n.jsx)("strong", { children: t }),
										" · ",
										r,
										...
										className: "meta",
										children: o(e.recorded_at)
									}) })] }, e.id);
								})
							}),
							/* @__PURE__ */ (0, n.jsx)("div", {
								className: "activity-footer",
								children: re.length > r ? /* @__PURE__ */ (0, n.jsx)("button", {
									type: "button",
									className: "activity-toggle",
									onClick: () => fe((e) => !e),
							...
							re.length === 0 ? /* @__PURE__ */ (0, n.jsx)("p", {
								className: "small-muted",
								children: ie || "No recent activity."
							}) : null
						] }) : null]
					})]
				})
	...
	function m() {
		...
		e && (0, t.createRoot)(e).render(/* @__PURE__ */ (0, n.jsx)(p, {}));
	}
