...
var t = Object.create, n = Object.defineProperty, r = Object.getOwnPropertyDescriptor, i = Object.getOwnPropertyNames, a = Object.getPrototypeOf, o = Object.prototype.hasOwnProperty, s = (e, t) => () => (e && (t = e(e = 0)), t), c = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), l = (e, t, a, s) => {
	...
	function be(e) {
		me.current === e && (O(A), O(me)), ge.current === e && (O(ge), Qf._currentValue = ue);
	}
	var xe, Se;
	function Ce(e) {
		if (xe === void 0) try {
	...
	function bi(e, t, n, r, a, o) {
		...
		if (r = e, typeof e == "function") _i(e) && (s = 1);
		else if (typeof e == "string") s = Uf(e, n, A.current) ? 26 : e === "html" || e === "head" || e === "body" ? 27 : 5;
		else a: switch (e) {
			...
			case w: return e = gi(13, n, t, a), e.elementType = w, e.lanes = o, e;
		...
		switch (zi(t), t.tag) {
			...
			case 27:
				if (be(t), n = he.current, a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Ic(t);
					...
					e = A.current, Ji(t) ? Ki(t, e) : (e = ff(a, r, n), t.stateNode = e, Ic(t));
				}
				return V(t), null;
			case 5:
	...
	function If(e, t, n) {
		if (t.count++, t.instance === null) switch (t.type) {
			...
			case "script": return o = Pf(n.src), (a = e.querySelector(Ff(o))) ? (t.instance = a, Dt(a), a) : (r = n, (a = mf.get(o)) && (r = p({}, n), zf(r, a)), e = e.ownerDocument || e, a = e.createElement("script"), Dt(a), Pd(a, "link", r), e.head.appendChild(a), t.instance = a);
...
async function y(e) {
	...
	try {
		let { data: r, error: i } = await w.from("users").select("id, name, email, role").eq("id", e.id);
		if (i && console.warn("User sync select failed", i), r && r.length > 0) {
			...
			if (c && c !== s && (a.email = c), l && (!o || s && o === s) && l !== o && (a.name = l), Object.prototype.hasOwnProperty.call(a, "name") || Object.prototype.hasOwnProperty.call(a, "email")) {
				let { error: t } = await w.from("users").update(a).eq("id", e.id);
		...
		let a = (/* @__PURE__ */ new Date()).toISOString(), o = {
			...
			created_at: a,
			updated_at: a
		}, { error: s } = await w.from("users").insert([o]);
		if (s) {
			console.warn("User sync insert failed", s);
			try {
				let { data: t } = await w.from("users").select("id").eq("id", e.id);
...
function b(e, t = !1) {
	ne && (ne.textContent = e, ne.style.color = t ? "crimson" : "green");
}
async function x() {
	try {
		let e = window.location.origin + "/FrameRegister.html", { error: t } = await w.auth.signInWithOAuth({
			provider: "google",
			options: { redirectTo: e }
		});
		if (t) throw t;
	} catch (e) {
		b("Google sign-in error: " + (e.message || e), !0), console.error("signInWithGoogle error", e);
	}
}
async function ee(e) {
	if (T) return;
	...
	if (a && r && !i && !t.email_confirmed_at) {
		await w.auth.signOut(), b("Please check your email to confirm your account.", !1);
		return;
	}
	let o = await y(t);
	if (a) {
		b(o ? "Account created successfully! Redirecting..." : "Signed in. Redirecting...", !1), setTimeout(() => {
			window.location.href = "FrameDashboard.html";
		}, 1500);
		return;
	}
	b("Signed in as " + (n || t.id), !1), console.log("Supabase session:", e);
}
var S, C, w, te, ne, T, re = s((() => {
	S = "https://xsgymjzkuiohsqalrqkw.supabase.co", C = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhzZ3ltanprdWlvaHNxYWxycWt3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI2Mjk2NjMsImV4cCI6MjA4ODIwNTY2M30.CKZoZbIu0MDZplXl_8Qf-K6n5nFaPMvp4ZHp7TcdIkM", w = e(S, C), te = document.getElementById("gSignUpBtn"), ne = document.getElementById("register-message"), te && te.addEventListener("click", x), T = !1, (async function() {
		try {
			if (typeof w.auth.getSessionFromUrl == "function") try {
				let { data: e, error: t } = await w.auth.getSessionFromUrl({ storeSession: !0 });
				t && !/No URL parameters found/.test(t.message || "") && console.warn("getSessionFromUrl warning", t);
			} catch (e) {
				console.warn("getSessionFromUrl failed", e);
			}
			let { data: e } = await w.auth.getSession(), t = e.session;
			t && ee(t);
		} catch (e) {
			console.error("OAuth redirect handling failed", e);
		}
	})(), w.auth.onAuthStateChange((e, t) => {
		t ? ee(t) : e === "SIGNED_OUT" && b("Signed out", !1);
	});
}));
//#endregion
//#region JS/services/map-data.js
async function ie(e) {
	let { data: t, error: n } = await e.from("resources").select("resource_type").not("resource_type", "is", null);
	if (n) throw n;
...
async function ae(e) {
	let { data: t, error: n } = await e.from("resources").select("location").not("location", "is", null);
	if (n) throw n;
	return [...new Set((t || []).map(function(e) {
		return e.location;
	}))].filter(Boolean).sort();
...
async function oe(e, t) {
	let { data: n, error: r } = await e.from("resources").select("location").eq("resource_type", t).not("location", "is", null);
	if (r) throw r;
	...
	async function se(e, t, n, r) {
		let i = "id,name,location,resource_type,capacity,current_occupancy,is_active,created_at", a = i + ",updated_at", o = r ? [a, i] : [i], s = [!0, !1], c = null, l = (r, i) => {
			let a = e.from("resources").select(r).eq("resource_type", t).eq("location", n);
			return i && (a = a.or("is_active.is.null,is_active.eq.true")), a.order("name", { ascending: !0 });
		};
		for (let e of o) for (let t of s) try {
			let { data: n, error: r } = await l(e, t);
			if (r) throw r;
			return n || [];
		} catch (e) {
			c = e;
			let t = String(e?.message || e?.details || ""), n = Number(e?.status || 0), r = n === 400 || e?.code === "42703" || /(schema cache|column|updated_at|is_active)/i.test(t);
			if (!r) throw e;
		}
		if (c) throw c;
		return [];
...
async function ce(e, t, n) {
	let { data: r, error: i } = await e.from("reservations").select("resource_id,status,reserved_from,reserved_until").in("resource_id", t).in("status", ["pending", "confirmed"]).lte("reserved_from", n).gte("reserved_until", n);
	if (i) throw i;
	return r || [];
}
var le = s((() => {})), E = /* @__PURE__ */ c(((e) => {
	...
	var n = D();
	function r(e) {
		return String(e || "").replace(/_/g, " ").split(" ").map((e) => e.charAt(0).toUpperCase() + e.slice(1).toLowerCase()).join(" ");
	}
	function i() {
		return (/* @__PURE__ */ new Date()).toISOString();
	}
	function a(e) {
		return e && (e.is_active === !0 || e.is_active == null);
	}
	function o(e) {
		let t = e?.__lastChangeAt || e?.updated_at || e?.created_at;
		if (!t) return "Updated: —";
		let n = new Date(t);
		return Number.isNaN(n.getTime()) ? "Updated: —" : `Updated: ${n.toLocaleString("en-US", {
			month: "short",
			day: "numeric",
			hour: "2-digit",
			minute: "2-digit"
	...
	function s(e, t) {
		...
		let n = Number(e.capacity || 0), r = Number(e.current_occupancy || 0);
		return n > 0 && r >= n ? {
			label: "Occupied",
			tone: "occupied"
		} : {
	...
	function c({ label: t, value: r, options: i, onChange: a, disabled: o = !1, placeholder: s = "Select" }) {
		let [c, l] = (0, e.useState)(!1), u = (0, e.useRef)(null), d = (0, e.useMemo)(() => i.find((e) => e.value === r), [i, r]);
		(0, e.useEffect)(() => {
			o && l(!1);
		}, [o]), (0, e.useEffect)(() => {
			let e = (e) => {
		...
		return /* @__PURE__ */ (0, n.jsxs)("label", {
			className: `smooth-select-label ${o ? "is-disabled" : ""}`,
			children: [t, /* @__PURE__ */ (0, n.jsxs)("div", {
				className: `smooth-select ${c ? "is-open" : ""}`,
				ref: u,
				children: [/* @__PURE__ */ (0, n.jsxs)("button", {
					type: "button",
					...
					"aria-expanded": c,
					disabled: o,
					children: [/* @__PURE__ */ (0, n.jsx)("span", { children: d?.label || s }), /* @__PURE__ */ (0, n.jsx)("span", {
						className: "smooth-select-caret",
						"aria-hidden": "true",
						children: "▾"
					})]
				}), /* @__PURE__ */ (0, n.jsx)("ul", {
					className: "smooth-select-menu",
					role: "listbox",
					"aria-hidden": c ? "false" : "true",
					children: i.map((e) => /* @__PURE__ */ (0, n.jsx)("li", { children: /* @__PURE__ */ (0, n.jsx)("button", {
						type: "button",
						className: `smooth-select-option ${e.value === r ? "is-selected" : ""}`,
						role: "option",
	...
	function R({ value: t, minDigits: r = 2 }) {
		let i = Number(t || 0);
		Number.isFinite(i) || (i = 0), i = Math.max(0, Math.floor(i));
		let a = String(i).split("").map((e) => Number(e)), [o, s] = (0, e.useState)(() => Math.max(r, a.length));
		(0, e.useEffect)(() => {
			s((e) => Math.max(e, r, a.length));
		}, [a.length, r]);
		let c = (0, e.useMemo)(() => {
			let e = Math.max(0, o - a.length);
			return [...Array.from({ length: e }, () => null), ...a];
		}, [a, o]);
		return /* @__PURE__ */ (0, n.jsx)("div", {
			className: "roll-number",
			"aria-label": String(i),
			children: c.map((e, t) => /* @__PURE__ */ (0, n.jsx)("span", {
				className: `roll-digit-slot ${e == null ? "is-leading-empty" : ""}`,
				children: /* @__PURE__ */ (0, n.jsx)(M, { digit: e ?? 0 })
			}, `slot-${t}`))
		});
	}
	function l() {
		let [t, l] = (0, e.useState)("all"), [u, d] = (0, e.useState)("all"), [f, p] = (0, e.useState)([]), [m, h] = (0, e.useState)([]), [g, _] = (0, e.useState)(/* @__PURE__ */ new Map()), [v, y] = (0, e.useState)(/* @__PURE__ */ new Set()), [b, x] = (0, e.useState)(!1), [ee, S] = (0, e.useState)(null), [C, te] = (0, e.useState)(!0), ne = (0, e.useRef)(!1), T = (0, e.useRef)(t), re = (0, e.useRef)(u), le = (0, e.useRef)(g), E = (0, e.useRef)(null), D = (0, e.useRef)(!1), ue = (0, e.useRef)(!1), de = (0, e.useRef)(null);
		(0, e.useEffect)(() => {
			T.current = t;
		}, [t]), (0, e.useEffect)(() => {
			re.current = u;
		...
		let fe = (0, e.useMemo)(() => t !== "all" && u !== "all", [t, u]), pe = (0, e.useMemo)(() => f.map((e) => ({
			value: e,
			label: r(e)
		})), [f]), O = (0, e.useCallback)((e, t = "info") => {
			S({
				message: e,
				type: t
			}), de.current && clearTimeout(de.current), de.current = setTimeout(() => {
				S(null), de.current = null;
			}, 3500);
		}, []);
		(0, e.useEffect)(() => () => {
			de.current && clearTimeout(de.current), E.current && clearInterval(E.current);
		}, []);
		let k = (0, e.useCallback)(async (e, t) => {
			try {
				return await se(w, e, t, ne.current);
			} catch (n) {
				if (ne.current) {
					let r = String(n?.message || n?.details || ""), i = String(n?.code || ""), a = i === "42703" || /updated_at/i.test(r) && /(does not exist|column|schema cache)/i.test(r);
					if (a) return ne.current = !1, k(e, t);
				}
				throw n;
			}
		}, []), A = (0, e.useCallback)(async (e) => {
			let t = T.current, n = re.current;
			if (t === "all" || n === "all") {
				y(/* @__PURE__ */ new Set());
				return;
			}
			let r = e || Array.from(le.current.keys());
			if (!r.length) {
				y(/* @__PURE__ */ new Set());
				return;
			}
			...
			D.current = !0, ue.current = !1;
			try {
				let e = await ce(w, r, i());
				y(new Set((e || []).map((e) => e.resource_id).filter(Boolean)));
			} catch {
				y(/* @__PURE__ */ new Set());
			} finally {
				D.current = !1, ue.current && (ue.current = !1, A(r));
			}
		}, []), me = (0, e.useCallback)(() => {
			E.current &&= (clearInterval(E.current), null);
		}, []), he = (0, e.useCallback)(() => {
			E.current ||= setInterval(async () => {
				T.current === "all" || re.current === "all" || await A();
			}, 3e4);
		}, [A]), ge = (0, e.useCallback)(async (e, t) => {
			if (e === "all" || t === "all") {
				_(/* @__PURE__ */ new Map()), y(/* @__PURE__ */ new Set()), me();
				return;
			}
			x(!0);
			try {
				let n = await k(e, t), r = /* @__PURE__ */ new Map();
				(n || []).forEach((e) => {
					let t = e.updated_at || e.created_at || i();
					r.set(e.id, {
						...e,
						__lastChangeAt: t
					});
				}), _(r), await A(Array.from(r.keys())), he();
			} catch (e) {
				console.error("Map load resources error", e), O("Failed to load resources.", "error"), _(/* @__PURE__ */ new Map()), y(/* @__PURE__ */ new Set()), me();
			} finally {
				x(!1);
			}
		}, [
			...
			he,
			me
		]), _e = (0, e.useCallback)(async (e, t = !1) => {
			let n = e === "all" ? await ae(w) : await oe(w, e);
			return h(n), t && n.includes(re.current) ? re.current : n.length === 1 ? (d(n[0]), n[0]) : (d("all"), "all");
		}, []), ve = (0, e.useCallback)(async () => {
			te(!0);
			try {
				let [e, t] = await Promise.all([ie(w), ae(w)]);
				p(e), h(t);
			} catch (e) {
				console.error("Map initialize error", e), O("Unable to load filters right now.", "error");
			} finally {
				te(!1);
			}
		}, [O]);
		(0, e.useEffect)(() => {
			...
			let e = null, t = null;
			e = w.channel("map-resources-live-react").on("postgres_changes", {
				event: "*",
				schema: "public",
				table: "resources"
			}, (e) => {
				...
				let r = e.new;
				if (r?.id) {
					if (r.resource_type === t && r.location === n && a(r)) {
						_((e) => {
							let t = new Map(e);
							return t.set(r.id, {
								...r,
					...
					_((e) => {
						if (!e.has(r.id)) return e;
						let t = new Map(e);
						return t.delete(r.id), t;
					}), A();
				}
			}), t = w.channel("map-reservations-live-react").on("postgres_changes", {
				event: "*",
				schema: "public",
				table: "reservations"
			}, (e) => {
				...
				let t = T.current, n = re.current;
				if (t === "all" || n === "all") return;
				let r = e.new?.resource_id || e.old?.resource_id;
				r && le.current.has(r) && A();
			});
			try {
				e.subscribe(() => {});
			} catch {
			...
			return () => {
				me(), e && w.removeChannel(e), t && w.removeChannel(t);
			};
		}, [A, me]);
		let ye = (0, e.useMemo)(() => Array.from(g.values()).filter((e) => e.resource_type === t && e.location === u && a(e)).sort((e, t) => {
			let n = {
				available: 0,
				reserved: 1,
				occupied: 2
			}, r = n[s(e, v).tone] - n[s(t, v).tone];
			return r === 0 ? String(e.name || "").localeCompare(String(t.name || ""), void 0, { sensitivity: "base" }) : r;
		}), [
			g,
			v,
			u,
			...
			return ye.forEach((r) => {
				let i = s(r, v);
				i.tone === "available" && (e += 1), i.tone === "reserved" && (t += 1), i.tone === "occupied" && (n += 1);
			}), {
				total: ye.length,
				available: e,
				reserved: t,
		...
		}, [ye, v]), xe = (0, e.useMemo)(() => fe ? b ? "Loading spaces for your selection…" : "No resources found for this selection." : "Choose a type and location to see available spaces.", [fe, b]), Se = async (e) => {
			l(e), await _e(e);
		}, Ce = async (e) => {
			if (!f.includes(e)) {
				O("That quick pick is not available right now.", "info");
				return;
			}
			l(e), await _e(e, !0);
		};
		return /* @__PURE__ */ (0, n.jsxs)("div", {
			className: "map-page map-page-react",
			children: [/* @__PURE__ */ (0, n.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, n.jsx)("div", {
						...
						children: ee ? /* @__PURE__ */ (0, n.jsx)("div", {
							className: `status-${ee.type}`,
							children: ee.message
						}) : null
					}),
					/* @__PURE__ */ (0, n.jsxs)("header", {
						...
						children: [/* @__PURE__ */ (0, n.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, n.jsx)("h1", { children: "Find a Space" }), /* @__PURE__ */ (0, n.jsx)("p", { children: "Filter by resource and location to instantly see what is available right now." })]
					...
					/* @__PURE__ */ (0, n.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, n.jsx)("p", {
							...
							role: "group",
							"aria-label": "Popular resource types",
							children: pe.map((e) => /* @__PURE__ */ (0, n.jsx)("button", {
								type: "button",
								className: `quick-filter-chip ${t === e.value ? "is-active" : ""}`,
								onClick: () => Ce(e.value),
								children: e.label
							}, e.value))
						})]
					}),
					fe && ye.length > 0 ? /* @__PURE__ */ (0, n.jsxs)("section", {
						className: "map-stats",
						"aria-label": "Map quick stats",
						children: [
							/* @__PURE__ */ (0, n.jsxs)("div", {
								className: "stat-box",
								children: [/* @__PURE__ */ (0, n.jsx)("div", { children: "Total" }), /* @__PURE__ */ (0, n.jsx)(R, { value: be.total })]
							}),
							/* @__PURE__ */ (0, n.jsxs)("div", {
								className: "stat-box free",
								children: [/* @__PURE__ */ (0, n.jsx)("div", { children: "Available" }), /* @__PURE__ */ (0, n.jsx)(R, { value: be.available })]
							}),
							/* @__PURE__ */ (0, n.jsxs)("div", {
								className: "stat-box reserved",
								children: [/* @__PURE__ */ (0, n.jsx)("div", { children: "Reserved" }), /* @__PURE__ */ (0, n.jsx)(R, { value: be.reserved })]
							}),
							/* @__PURE__ */ (0, n.jsxs)("div", {
								className: "stat-box occupied",
								children: [/* @__PURE__ */ (0, n.jsx)("div", { children: "Occupied" }), /* @__PURE__ */ (0, n.jsx)(R, { value: be.occupied })]
							})
						]
					}) : null,
					ye.length > 0 && fe ? /* @__PURE__ */ (0, n.jsx)("section", {
								...
								return /* @__PURE__ */ (0, n.jsxs)("article", {
									...
									children: [/* @__PURE__ */ (0, n.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, n.jsx)("h3", {
											...
											children: e.location || "No location"
										})]
									}), /* @__PURE__ */ (0, n.jsxs)("div", {
										className: "resource-right",
										children: [/* @__PURE__ */ (0, n.jsx)("span", {
											className: `availability-badge ${t.tone}`,
											children: t.label
										}), /* @__PURE__ */ (0, n.jsxs)("p", {
											className: "resource-occupancy",
											children: ["Current occupancy: ", Number(e.current_occupancy || 0), Number(e.capacity || 0) > 0 ? ` / ${Number(e.capacity || 0)}` : ""]
										}), /* @__PURE__ */ (0, n.jsx)("p", {
											className: "resource-updated",
											children: o(e)
										})]
									})]
								}, e.id);
						...
						children: /* @__PURE__ */ (0, n.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, n.jsx)("p", { children: xe })
						})
					})
				]
			}), /* @__PURE__ */ (0, n.jsx)("div", {
	...
	function d() {
		let e = document.getElementById("mapReactRoot");
		e && (0, t.createRoot)(e).render(/* @__PURE__ */ (0, n.jsx)(l, {}));
	}
