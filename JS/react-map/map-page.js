...
async function se(e, t, n, r) {
	let i = "id,name,location,resource_type,capacity,current_occupancy,is_active,created_at", a = r ? i + ",updated_at" : i, { data: o, error: s } = await e.from("resources").select(a).eq("resource_type", t).eq("location", n).or("is_active.is.null,is_active.eq.true").order("name", { ascending: !0 });
	if (s) throw s;
	return o || [];
}
...
var le = s((() => {})), E = /* @__PURE__ */ c(((e) => {
	...
	function l() {
		let [t, l] = (0, e.useState)("all"), [u, d] = (0, e.useState)("all"), [f, p] = (0, e.useState)([]), [m, h] = (0, e.useState)([]), [g, _] = (0, e.useState)(/* @__PURE__ */ new Map()), [v, y] = (0, e.useState)(/* @__PURE__ */ new Set()), [b, x] = (0, e.useState)(!1), [ee, S] = (0, e.useState)(null), [C, te] = (0, e.useState)(!0), ne = (0, e.useRef)(!0), T = (0, e.useRef)(t), re = (0, e.useRef)(u), le = (0, e.useRef)(g), E = (0, e.useRef)(null), D = (0, e.useRef)(!1), ue = (0, e.useRef)(!1), de = (0, e.useRef)(null);
		(0, e.useEffect)(() => {
			T.current = t;
		}, [t]), (0, e.useEffect)(() => {
			re.current = u;
		...
		let k = (0, e.useCallback)(async (e, t) => {
			try {
				...
				if (ne.current) {
					let r = String(n?.message || n?.details || "");
					if (/updated_at/i.test(r) && /does not exist/i.test(r)) return ne.current = !1, k(e, t);
				}
				throw n;
			}
				...
				children: [
					...
					fe && ye.length > 0 ? /* @__PURE__ */ (0, n.jsxs)("section", {
						...
						children: [
							/* @__PURE__ */ (0, n.jsxs)("div", {
								className: "stat-box",
								children: [/* @__PURE__ */ (0, n.jsx)("div", { children: "Total" }), /* @__PURE__ */ (0, n.jsx)("div", { children: be.total })]
							}),
							/* @__PURE__ */ (0, n.jsxs)("div", {
								className: "stat-box free",
								children: [/* @__PURE__ */ (0, n.jsx)("div", { children: "Available" }), /* @__PURE__ */ (0, n.jsx)("div", { children: be.available })]
							}),
							/* @__PURE__ */ (0, n.jsxs)("div", {
								className: "stat-box reserved",
								children: [/* @__PURE__ */ (0, n.jsx)("div", { children: "Reserved" }), /* @__PURE__ */ (0, n.jsx)("div", { children: be.reserved })]
							}),
							/* @__PURE__ */ (0, n.jsxs)("div", {
								className: "stat-box occupied",
								children: [/* @__PURE__ */ (0, n.jsx)("div", { children: "Occupied" }), /* @__PURE__ */ (0, n.jsx)("div", { children: be.occupied })]
							})
						]
					}) : null,
