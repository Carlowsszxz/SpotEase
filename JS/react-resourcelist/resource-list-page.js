...
var S, C, w, te, ne, T, re = s((() => {
	...
	var n = ae(), r = [
		...
		},
		{
			...
			label: "Sort: Available First"
		},
		{
			value: "capacity-desc",
			label: "Sort: Capacity (High-Low)"
		}
	];
	function i(e) {
		if (!e) return "other";
		let t = String(e).toLowerCase();
		return t.includes("parking") ? "parking" : t.includes("seat") ? "seat" : t.includes("room") || t.includes("meeting") ? "room" : t;
	}
	function a(e) {
		if (!e || e.is_active === !1) return "inactive";
		let t = Number(e.capacity || 0), n = Number(e.current_occupancy || 0);
		if (t > 0 && n >= t) return "occupied";
		let r = String(e.current_status || e.reservation_status || e.occupancy_status || "").toLowerCase();
		return r === "inactive" ? "inactive" : r === "occupied" || r === "full" ? "occupied" : "free";
	}
	function o(e) {
		let t = String(e || "");
	...
	function s(e) {
		return e === "free" ? "s-free" : e === "occupied" ? "s-occupied" : e === "inactive" ? "s-inactive" : "s-pending";
	}
	function c(e, t) {
		let n = (e || []).slice();
		return n.sort((e, n) => {
			if (t === "name-desc") return String(n.name || "").localeCompare(String(e.name || ""), void 0, { sensitivity: "base" });
			if (t === "capacity-desc") return Number(n.capacity || 0) - Number(e.capacity || 0);
			if (t === "available-first") {
				let t = e.status === "free" ? 0 : e.status === "occupied" ? 1 : 2, r = n.status === "free" ? 0 : n.status === "occupied" ? 1 : 2;
				if (t !== r) return t - r;
			}
			return String(e.name || "").localeCompare(String(n.name || ""), void 0, { sensitivity: "base" });
		}), n;
	}
	function l(e) {
	...
	function d() {
		let [t, u] = (0, e.useState)([]), [d, f] = (0, e.useState)(!0), [p, m] = (0, e.useState)("Loading resources..."), [h, g] = (0, e.useState)(!1), [_, v] = (0, e.useState)(""), [y, b] = (0, e.useState)(""), [x, ee] = (0, e.useState)("all"), [S, C] = (0, e.useState)("all"), [te, ne] = (0, e.useState)("all"), [T, re] = (0, e.useState)("name-asc"), ie = (0, e.useMemo)(() => ["all", ...l(t.map((e) => e.type || "other"))], [t]), ae = (0, e.useMemo)(() => ["all", ...l(t.map((e) => e.status || "free"))], [t]), oe = (0, e.useMemo)(() => ["all", ...l(t.map((e) => e.location || "Unknown"))], [t]), se = (0, e.useMemo)(() => {
			let e = String(y || "").trim().toLowerCase();
			return c(t.filter((t) => !(x !== "all" && t.type !== x || S !== "all" && t.status !== S || te !== "all" && t.location !== te || e && ![
				t.name,
				t.type,
				t.location,
				t.status
			].join(" ").toLowerCase().includes(e))), T);
		}, [
			te,
			t,
			y,
			...
			total: se.length,
			available: se.filter((e) => e.status === "free").length,
			occupied: se.filter((e) => e.status === "occupied").length
		}), [se]);
		async function le() {
			f(!0), g(!1), m("Loading resources...");
			try {
				let { data: e, error: t } = await w.from("resources").select("*").eq("is_active", !0);
				if (t) {
					u([]), g(!0), m(`Failed to load resources: ${t.message || "Unknown error"}`);
					return;
				}
				u((e || []).map((e) => ({
					id: e.id,
					name: e.name || e.resource_name || "",
					type: i(e.resource_type || e.type),
					location: e.location || "Unknown",
					capacity: e.capacity || 1,
					current_occupancy: e.current_occupancy || 0,
					is_active: e.is_active,
					status: a(e)
				}))), m(""), g(!1), v(`Updated: ${(/* @__PURE__ */ new Date()).toLocaleTimeString()}`);
			} catch (e) {
				u([]), g(!0), m(`Error loading resources: ${e?.message || e}`);
			} finally {
				f(!1);
			}
		}
		...
		function E() {
			b(""), ee("all"), C("all"), ne("all"), re("name-asc");
		}
		function D(e) {
			try {
		...
		return /* @__PURE__ */ (0, n.jsxs)(n.Fragment, { children: [/* @__PURE__ */ (0, n.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, n.jsx)("div", {
					className: `status-bar ${h ? "error" : ""}`,
					"aria-live": "polite",
					children: p
				}),
				/* @__PURE__ */ (0, n.jsxs)("section", {
					className: "rl-controls",
					children: [
						...
						/* @__PURE__ */ (0, n.jsx)("select", {
							...
							children: ie.map((e) => /* @__PURE__ */ (0, n.jsx)("option", {
								value: e,
								children: e === "all" ? "All types" : o(e)
							}, e))
						}),
						/* @__PURE__ */ (0, n.jsx)("select", {
							value: S,
							onChange: (e) => C(e.target.value),
							children: ae.map((e) => /* @__PURE__ */ (0, n.jsx)("option", {
								value: e,
								children: e === "all" ? "All status" : o(e)
							}, e))
						}),
						/* @__PURE__ */ (0, n.jsx)("select", {
							value: te,
							onChange: (e) => ne(e.target.value),
							children: oe.map((e) => /* @__PURE__ */ (0, n.jsx)("option", {
								value: e,
								children: e === "all" ? "All locations" : e
							}, e))
						}),
						/* @__PURE__ */ (0, n.jsx)("select", {
							value: T,
							onChange: (e) => re(e.target.value),
							children: r.map((e) => /* @__PURE__ */ (0, n.jsx)("option", {
								value: e.value,
								children: e.label
							}, e.value))
						}),
				...
				/* @__PURE__ */ (0, n.jsx)("section", {
					className: "rl-table",
					children: /* @__PURE__ */ (0, n.jsxs)("table", { children: [/* @__PURE__ */ (0, n.jsx)("thead", { children: /* @__PURE__ */ (0, n.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, n.jsx)("th", { children: "Name" }),
						/* @__PURE__ */ (0, n.jsx)("th", { children: "Type" }),
						/* @__PURE__ */ (0, n.jsx)("th", { children: "Location" }),
						/* @__PURE__ */ (0, n.jsx)("th", { children: "Capacity" }),
						/* @__PURE__ */ (0, n.jsx)("th", { children: "Status" }),
						...
						/* @__PURE__ */ (0, n.jsx)("td", { children: e.location }),
						/* @__PURE__ */ (0, n.jsx)("td", { children: e.capacity || "—" }),
						/* @__PURE__ */ (0, n.jsx)("td", { children: /* @__PURE__ */ (0, n.jsx)("span", {
							className: `status-badge ${s(e.status)}`,
							children: o(e.status)
						}) }),
						/* @__PURE__ */ (0, n.jsx)("td", { children: /* @__PURE__ */ (0, n.jsx)("button", {
							type: "button",
	...
	function p() {
		let e = document.getElementById("resourceListReactRoot");
		e && (0, t.createRoot)(e).render(/* @__PURE__ */ (0, n.jsx)(d, {}));
	}
