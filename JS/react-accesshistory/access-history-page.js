...
//#endregion
//#region JS/auth.js
async function ie(e = "FrameLogin.html") {
	try {
		let { data: t } = await w.auth.getSession(), n = t && t.session;
		if (!n) {
			try {
				localStorage.clear();
			} catch {}
		...
		console.error("checkAuth error", t);
		try {
			localStorage.clear();
		} catch {}
		try {
...
var ae = s((() => {
	...
	var n = se(), r = [
	...
	], i = "Asia/Manila", a = new Intl.DateTimeFormat("en-US", {
		timeZone: i,
		year: "numeric",
		month: "numeric",
		day: "numeric",
		...
		second: "2-digit",
		hour12: !0
	}), o = new Intl.DateTimeFormat("en-CA", {
		timeZone: i,
		year: "numeric",
		month: "2-digit",
		day: "2-digit"
	...
	function s(e) {
		let t = new Date(e);
		return Number.isNaN(t.getTime()) ? "" : o.format(t);
	}
	function c(e) {
		if (!e) return "—";
		let t = typeof e == "string" ? e.trim() : e;
		typeof t == "string" && (t.indexOf("T") === -1 && t.indexOf(" ") !== -1 && (t = t.replace(" ", "T")), t.endsWith("Z") || t.indexOf("+") !== -1 || /-\d\d:?\d\d$/.test(t) || (t = `${t}Z`));
		let n = new Date(t);
		return Number.isNaN(n.getTime()) ? typeof e == "string" ? e : "—" : a.format(n);
	}
	function l(e, t, n) {
		if (e === "all") return !0;
		let r = new Date(t);
		return Number.isNaN(r.getTime()) ? !1 : e === "today" ? s(r) === s(Date.now()) : e === "7d" ? n - r.getTime() <= 10080 * 60 * 1e3 : e === "30d" ? n - r.getTime() <= 720 * 60 * 60 * 1e3 : !0;
	}
	function d({ options: t, value: r, onChange: i }) {
		let [a, o] = (0, e.useState)(!1), s = (0, e.useRef)(null), c = (0, e.useMemo)(() => t.find((e) => e.value === r) || t[0], [t, r]);
		return (0, e.useEffect)(() => {
			...
			children: [/* @__PURE__ */ (0, n.jsxs)("button", {
				...
				"aria-expanded": a,
				children: [/* @__PURE__ */ (0, n.jsx)("span", { children: c?.label || "Select range" }), /* @__PURE__ */ (0, n.jsx)("span", {
					className: "ah-select-caret",
					"aria-hidden": "true",
					children: "▾"
				})]
			}), /* @__PURE__ */ (0, n.jsx)("ul", {
				className: "ah-select-menu",
				role: "listbox",
				"aria-hidden": a ? "false" : "true",
				children: t.map((e) => /* @__PURE__ */ (0, n.jsx)("li", { children: /* @__PURE__ */ (0, n.jsx)("button", {
					type: "button",
					className: `ah-select-option ${e.value === r ? "is-selected" : ""}`,
					role: "option",
	...
	function p() {
		let [t, i] = (0, e.useState)(!0), [a, o] = (0, e.useState)(!1), [s, u] = (0, e.useState)(""), [f, p] = (0, e.useState)([]), [m, h] = (0, e.useState)({}), [g, _] = (0, e.useState)(""), [v, y] = (0, e.useState)("all"), b = (0, e.useMemo)(() => {
			let e = String(g || "").trim().toLowerCase(), t = Date.now();
			return (f || []).filter((n) => {
				let r = n?.resource_id ? m[n.resource_id] : null, i = r?.name ? r.location ? `${r.name} ${r.location}` : r.name : "tap recorded";
				return e && !i.toLowerCase().includes(e) ? !1 : l(v, n?.scanned_at, t);
			});
		}, [
			f,
			m,
			v,
			g
		]), x = (0, e.useMemo)(() => b.length ? c(b[0]?.scanned_at) : "—", [b]), ee = (0, e.useMemo)(() => t ? "Loading…" : s ? "" : f.length ? b.length ? `Showing your latest ${b.length} RFID taps.` : "No taps match your filters." : "No activity yet for your assigned RFID tag.", [
			f.length,
			s,
			b.length,
			t
		...
		async function S(e = !1) {
			e && o(!0), u("");
			try {
				let { data: e } = await w.auth.getUser(), t = e?.user;
				if (!t) {
					p([]), h({});
					return;
				}
				let { data: n, error: r } = await w.from("rfid_scans").select("scanned_at, resource_id").eq("user_id", t.id).order("scanned_at", { ascending: !1 }).limit(200);
				if (r) {
					p([]), h({}), u("RFID activity is not available yet (missing database migration/policies).");
					return;
				}
				let i = n || [], a = [], o = {};
				i.forEach((e) => {
					let t = e?.resource_id;
					t && !o[t] && (o[t] = !0, a.push(t));
				});
				let s = {};
				if (a.length) {
					let { data: e, error: t } = await w.from("resources").select("id,name,location").in("id", a);
					!t && e && e.forEach((e) => {
						s[e.id] = e;
					});
				}
				...
				p([]), h({}), u("RFID activity is not available yet."), console.error("access history load failed", e);
			} finally {
				i(!1), o(!1);
			}
		}
		return (0, e.useEffect)(() => {
			let e = !0;
			return (async () => {
				!await ie("FrameLogin.html") || !e || await S(!1);
			})(), () => {
				e = !1;
			};
		}, []), /* @__PURE__ */ (0, n.jsxs)("div", {
			className: "access-history-page",
			children: [
				/* @__PURE__ */ (0, n.jsxs)("header", { children: [/* @__PURE__ */ (0, n.jsx)("h1", { children: "Access History" }), /* @__PURE__ */ (0, n.jsx)("p", {
					className: "small-muted",
					children: "Your recent RFID tap records."
				})] }),
				/* @__PURE__ */ (0, n.jsxs)("section", {
					className: "history-controls",
					"aria-label": "Access history controls",
					children: [
						...
						/* @__PURE__ */ (0, n.jsx)("button", {
							type: "button",
							className: `btn ${a ? "is-loading" : ""}`,
							onClick: () => S(!0),
							disabled: a,
							children: a ? "Refreshing…" : "Refresh"
						})
					]
				}),
				/* @__PURE__ */ (0, n.jsxs)("section", {
					className: "history-summary",
					"aria-label": "Access history summary",
					children: [/* @__PURE__ */ (0, n.jsxs)("div", {
						className: "summary-card",
						children: [/* @__PURE__ */ (0, n.jsx)("div", {
							className: "summary-label",
							children: "Visible taps"
						...
						children: [/* @__PURE__ */ (0, n.jsx)("div", {
							...
							className: "summary-value summary-value-small",
							children: x
						})]
					})]
				}),
				/* @__PURE__ */ (0, n.jsxs)("section", {
					className: "panel access-list-panel",
					"aria-labelledby": "accessHistoryTitle",
					children: [
						/* @__PURE__ */ (0, n.jsx)("h3", {
							id: "accessHistoryTitle",
							children: "Recent RFID Taps"
						}),
						/* @__PURE__ */ (0, n.jsx)("p", {
							className: "small-muted",
							children: ee
						}),
						s ? /* @__PURE__ */ (0, n.jsx)("p", {
							className: "small-muted history-error",
							children: s
						}) : null,
						/* @__PURE__ */ (0, n.jsx)("ul", {
							...
							"aria-live": "polite",
							children: b.map((e, t) => {
								let r = e?.resource_id ? m[e.resource_id] : null;
								return /* @__PURE__ */ (0, n.jsxs)("li", { children: [/* @__PURE__ */ (0, n.jsx)("div", {
									className: "access-where",
									children: r?.name ? r.location ? `${r.name} • ${r.location}` : r.name : "Tap recorded"
								}), /* @__PURE__ */ (0, n.jsx)("div", {
									className: "access-when",
									children: c(e?.scanned_at)
								})] }, `${e?.scanned_at || "tap"}-${t}`);
							})
						})
					]
	...
	function m() {
		let e = document.getElementById("accessHistoryReactRoot");
